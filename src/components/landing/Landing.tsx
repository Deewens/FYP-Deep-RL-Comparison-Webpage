                ...
                <LandingSection id="aboutSection" className="landing-section--first-section text-section"
                    ...
                    <div className="landing-section__content">
                        ...
                        <p className="landing-section__paragraph">
                            ...
                            Neural Networks and their modern alternative, Vision Transformers, in video game
                            environments.
                            ...
                            consistently throughout the experiments. This research also includes tables and graphics
                        ...
                        <p className="landing-section__paragraph">
                            ...
                            The conclusions drawn from this research provide information on the two neural networks and
                ...
                <LandingSection id="technologiesSection" className="text-section" color="secondary">
                    <div className="landing-section__content">
                        ...
                        <p className="landing-section__paragraph">
                            ...
                            frameworks were used for this project. All tools utilized were open source and widely
                            recognized
                            in the research community.
                        </p>
                        <h3 className="landing-section__h3">Frameworks and Libraries</h3>
                        <p className="landing-section__paragraph">
                            Python was chosen as the primary programming language for this project due to its widespread
                            use
                        ...
                        <table className="table-technology">
                            ...
                            <tr>
                                ...
                                <td>2.0</td>
                                <td>
                                    Machine Learning framework for deep neural networks developed by the Linux
                                    Foundation
                                    umbrella.
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td><a href="https://stable-baselines3.readthedocs.io/en/master/">Stable Baselines3</a>
                                </td>
                                <td>1.8.0</td>
                                <td>Set of reliable implementations of reinforcement learning algorithms in PyTorch.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>4.28.1</td>
                                <td>
                                    State-of-the-art collection of Transformers neural network architectures developed
                                    by
                                    Hugging Face.
                                </td>
                            </tr>
                        ...
                        <p className="landing-section__paragraph">
                            <ul>
                                <li><strong>Linux</strong> – Ubuntu-based Operating System (i.e. Pop!_OS or Ubuntu)
                                    version
                                    22.04
                                </li>
                                <li><strong>Miniconda:</strong> small bootstrapped version of Anaconda. Anaconda is an
                                    open-source package
                                    and environment management system that improves the default Python environment
                                    management
                                    and pip package manager.
                                </li>
                                <li><strong>JetBrains PyCharm Professional:</strong> my favourite multipurpose Python
                                    IDE
                                </li>
                ...
                <LandingSection id="experimentsSection" className="text-section" color="primary">
                    <div className="landing-section__content">
                        ...
                        <p className="landing-section__paragraph">
                            ...
                            measure the effectiveness of the two neural networks at solving the game environments, with
                            a
                        ...
                        <p className="landing-section--center">
                            <img src={CnnArchitectureImg} className="landing-section__image"
                                 alt="CNN Architecture Schema"/><br/>
                        ...
                        <p className="landing-section__paragraph">
                            ...
                            DQN, which includes a 32-filter convolutional layer with 8×8 filters and stride 4, a
                            64-filter
                        ...
                        <p className="landing-section__paragraph">
                            For the Swin Transformer architecture, the complexity of the model makes finding good
                            parameters
                            ...
                            attention heads, respectively. The patch size is set to 3×3, which yields 28×28 patches
                            given
                            the input size of 84×84 for the four channels. The embedding dimension for each patch is 96,
                            resulting in a token size of 784×96 after patch embedding. The local window size is 7×7 and
                            the
                            windows are shifted by 3 patches for the first and third blocks. The MLP ratio is 4,
                            indicating
                            that the linear layers within Swin Blocks have 4 times the embedding dimension hidden units,
                            i.e., 384. The drop path rate is set to 0.1, indicating a 10% chance that the input is kept
                            as
                ...
                <LandingSection id="resultsSection" className="text-section" color="secondary">
                    <div className="landing-section__content">
                        ...
                        <p className="landing-section__paragraph">
                            ...
                            architectures. For a more detailed explanation of the results, please refer to my thesis, as
                            the content on this webpage has been kept concise.
                        </p>
                        <h3 className="landing-section__h3">Pong</h3>
                        <div className="chart-results">
                            <div>
                                <img src={PongEpisodeMeanRewardImg}
                                     className="chart-results__img"
                        ...
                        <p className="landing-section__paragraph">
                            The CNN agent achieved good performance and required a relatively short training time of 7
                            hours and 36 minutes on a GTX 970 GPU. It began to converge around 500,000 steps, with a
                            stable
                            increase until it reached 3.5 million steps, where it stabilized. However, it did not
                            achieve a mean reward of +/- 20.
                        </p>

                        <p className="landing-section__paragraph">
                            The Swin Transformer-based DQN agent required a substantially longer training period of 3
                            days
                            and 7 hours on an RTX 3080 GPU. It only began to score positively at around 4 million steps,
                            but
                            showed a constant increase in performance compared to the CNN model. However, it was not
                            able to
                            achieve the same mean reward as the CNN model, achieving only around ~12. Its performance
                            curve
                        ...
                        <p className="landing-section__paragraph">
                            Also, an interesting comparison can be made between CNN and Swin, by observing the agents
                            playing
                            directly. The agent trained with CNN took actions in an erratic manner, whereas the Swin
                            Transformer appeared to be smoother, despite its lower mean reward. This behavior is
                            critical in
                            video games since the smoother it is, the more appealing it will be to a human player. This
                            behaviour can be seen in the video below and gives the impression that the Swin DQN agent
                            thinks
                            more before taking an action than the CNN agent (the agent is the right paddle, left paddle
                            is a
                            dummy computer AI).
                        ...
                        <p className="landing-section__paragraph">
                            The CNN agent was trained for 1 day and 7 hours on an NVIDIA GTX 970 GPU, while the Swin
                            agent
                            required a significantly longer training period of 3 days and 6 hours on an NVIDIA RTX 3080
                            GPU.
                            Interestingly, the Swin Breakout agent required less time to train than the Swin Pong agent,
                            while the CNN Breakout agent required more time than the CNN Pong agent, despite being
                            trained
                            on the same hardware and under the same conditions. The reasons for these results are not
                            immediately clear and may be due to random factors rather than the neural networks
                            themselves.
                        </p>
                        <p className="landing-section__paragraph">
                            In terms of performance, the CNN agent outperformed the Swin agent in Breakout, achieving a
                            mean
                            reward of almost 50 and a better episodic return overhaul, while the Swin DQN agent
                            occasionally
                            performed better for a few episodes. Overall, the Swin agent's performance was worse than
                            Pong,
                            with a mean reward that was more than double that of the CNN agent. The convergence point
                            for
                        ...
                        <p className="landing-section__paragraph">
                            ...
                            paper, Swin DQN and CNN DQN achieved relatively similar results, which became sparser closer
                            to
                ...
                <LandingSection id="conclusionSection" className="text-section" color="primary">
                    <div className="landing-section__content">
                        ...
                        <p className="landing-section__paragraph">
                            ...
                            variant with its CNN counterpart using the Deep Q Network (DQN) algorithm, a widely
                            recognized Reinforcement Learning (RL) algorithm. However, during the research phase, a
                            paper titled “Deep Reinforcement Learning with Swin Transformer” (Meng et al. 2022) was
                            encountered, which had already replaced the CNN with the Swin Transformer model. Despite
                            this, the idea of replicating their work and comparing my results with theirs remained
                            intriguing, especially given my limited knowledge of hyperparameter tuning if I were to try
                        ...
                        <p className="landing-section__paragraph">
                            ...
                            higher results obtained by Meng et al. (2022) demonstrate that the Swin Transformer requires
                            a significantly higher number of training steps.
                        </p>
                        <p className="landing-section__paragraph">
                            Training an agent with Swin Transformer is computationally intensive and requires
                            significant GPU memory, making it challenging for an average computer and not feasible for
                            consumer
                            video games due to the low number of individuals who own such hardware. Therefore, the CNN
                            remains
                            a viable option for high-performance algorithms, considering the hardware of the end-user
                            machine.
                        </p>
                        <p className="landing-section__paragraph">
                            Despite this, the Swin Transformer offers certain advantages over the CNN that are not
                            related to raw performance. A fascinating comparison can be made between the CNN and Swin by
                            observing the agents playing directly. The agent trained with CNN took actions in an erratic
                            manner,
                            whereas the Swin Transformer appeared to be smoother, despite its lower mean reward. This
                            behavior is critical in video games since the smoother it is, the more appealing it will be
                            to a human player.
                        </p>
                    </div>
                </LandingSection>
                ...
                <LandingSection id="contactSection" className="text-section" color="secondary">
                    <div className="landing-section__content">
                        ...
                        <div className="footer-section">
                            <div className="footer-section__networks">
                                <p className="landing-section__paragraph">
                                    Hey, I'm <strong>Adrien Dudon</strong>, I am glad you scrolled until the end :-)
                                    !<br/>
                                    Are you interested in my project or my profile? Do not hesitate to contact me either
                                    by
                            ...
                            <div className="footer-section__photo">
                                <img className="footer-section__photo--img" src={AdrienDudonPhoto}
